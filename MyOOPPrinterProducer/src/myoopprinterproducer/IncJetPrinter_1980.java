 ...
 * @author LeeJaeseok
 */
public class IncJetPrinter_1980 {
    ...
    public IncJetPrinter_1980(String printerName) {
        this.printerName = printerName;
        System.out.println("Printer Name : " + this.printerName);
    }

    public IncJetPrinter_1980(String category, String printerName) {
        this(printerName);
        this.category = category;
        System.out.println("Category : " + this.category);
    }

    public IncJetPrinter_1980(String category, String printerName, String dpi) {
        this(category, printerName);
        this.dpi = dpi;
        System.out.println("DPI : " + this.dpi);
    }

    public IncJetPrinter_1980(String category, String printerName, String dpi, boolean supportColor,
